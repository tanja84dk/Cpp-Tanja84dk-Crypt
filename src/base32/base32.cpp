...
Base32::Base32(const std::string &input_data) noexcept {
    ...
    this->_input_data_length = input_data.size();
}
...
std::string Base32::decode() const noexcept {
    ...
    Decoder.Put((CryptoPP::byte *)this->_input_data.data(), this->_input_data.length());
    Decoder.MessageEnd();
...
std::string Base32::encode() const noexcept {
    ...
    Encoder.Put((CryptoPP::byte *)this->_input_data.data(), this->_input_data.length());
    Encoder.MessageEnd();
